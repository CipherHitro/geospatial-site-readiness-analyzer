...
async def compare_sites(request: CompareSitesRequest) -> CompareSitesResponse:
    ...
    system_prompt = (
        ...
        "and recommend the most suitable site.\n\n"
        "Formatting Requirements:\n"
        "1. Use **bold** for key metrics, site names, and specific values.\n"
        "2. Use bulleted lists to compare strengths and weaknesses.\n"
        "3. Provide a detailed rationale for your recommendation, highlighting the key strengths "
